...
INSERT INTO `creature_template` (`entry`, `name`, `subname`, `minlevel`, `maxlevel`, `exp`, `faction`, `speed_walk`, `speed_run`, `unit_class`, `unit_flags2`, `type`, `RegenHealth`, `flags_extra`, `ScriptName`, `VerifiedBuild`) VALUES
(@ENTRY, @NAME, @SUBNAME, 80, 80, 2, 35, 1, 1.14286, 8, 2048, 7, 1, 2, @SCRIPTNAME, 0);
