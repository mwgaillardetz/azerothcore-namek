...
INSERT INTO `creature_template` (`entry`, `name`, `subname`, `IconName`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `speed_walk`, `speed_run`, `rank`, `DamageModifier`, `unit_class`, `unit_flags`, `type`, `RegenHealth`, `flags_extra`, `ScriptName`, `VerifiedBuild`) VALUES
(601020, 'Loita', 'Dobbo Girl', 'LootAll', 80, 80, 35, 1, 1, 1.14286, 4, 1, 1, 4, 7, 1, 16777216, 'gamble_npc', 0);
-- NPC Model
