...
# — war fronts, politics, economy, and happenings across the world.
NEWS_CHAT_TOPICS = [
    'discussing the latest reports from the war front',
    'sharing a rumor about troop movements near the border',
    'arguing about the Crown\'s latest decree or tax',
    'talking about a diplomatic envoy arriving from the other faction',
    'mentioning a scandal involving a well-known noble or officer',
    'discussing news of a plague or sickness spreading in a distant region',
    'talking about a new trade agreement between two cities',
    'sharing word of a great victory or heavy defeat in a recent battle',
    'mentioning the price of grain jumping after a bad harvest',
    'gossiping about who is rumored to be the next army commander',
    'talking about a famous adventurer who just returned from a dangerous expedition',
    'discussing reports of strange creatures sighted far from home',
    'mentioning a messenger who arrived from a war-torn city',
    'arguing about whether the war is going well or badly',
    'talking about a royal wedding or funeral everyone is discussing',
    'sharing a rumor that the king\'s advisor is under investigation',
    'discussing new taxes being levied at the city gates',
    'talking about a healer who claims to have cured an untreatable disease',
    'mentioning a shipwreck or lost caravan that made the news',
    'speculating about a mysterious figure being hunted by the authorities',
]

# Sports-style topics — arena fights, duels, races, contests,
# and tavern gambling on competitions.
SPORTS_CHAT_TOPICS = [
    'arguing about who would win in a fight: a mage or a rogue',
    'discussing the odds on the next arena tournament',
    'talking about a legendary duel that happened at the arena',
    'bragging about a bet they won on a fighting pit match',
    'discussing the best wrestler in the region',
    'talking about a horse race that was decided by a nose',
    'mentioning a fishing contest and who caught the biggest catch',
    'arguing about which class is the strongest in a fight',
    'talking about a brawl between two rival guilds at the inn',
    'discussing the rules of an upcoming tournament',
    'mentioning a champion arena fighter everyone is talking about',
    'talking about a hunting competition to bring in the biggest trophy',
    'gambling talk about who will win the next tavern card game',
    'discussing a gnome racing contraption that blew up at the starting line',
    'talking about arm-wrestling matches at the inn and who is undefeated',
    'mentioning a sparring match between two famous soldiers',
    'discussing whether dwarves or gnomes make the better engineers in a race',
    'talking about a young upstart who beat a veteran in a duel',
    'arguing about the fairness of the arena matchmaking',
    'mentioning a prize purse that has drawn fighters from across the land',
]

# =============================================================================
# PERSONALITY ARCHETYPES
# =============================================================================
# Deterministic per-bot personalities so every speaker has a
# distinct, consistent voice. Each archetype biases the topic
# selection and injects voice/trait/tone lines into prompts.
# get_bot_archetype() in chatter_shared.py picks one stably
# from a bot guid/name hash.
PERSONALITY_ARCHETYPES = [
    {
        'key': 'gossip',
        'label': 'a gossipy town regular who loves scandal',
        'traits': [
            'inquisitive about other people\'s business',
            'remembers names and faces',
        ],
        'tone': 'eager, whispery, dramatic',
        'topic_lean': ['news', 'gossip'],
    },
    {
        'key': 'news_hound',
        'label': 'a news-hound who is always first with current events',
        'traits': [
            'well-informed about current affairs',
            'quick to share breaking reports',
        ],
        'tone': 'excited, breathless, informative',
        'topic_lean': ['news'],
    },
    {
        'key': 'sports_fan',
        'label': 'a passionate sports fan and arena regular',
        'traits': [
            'loves competition and gambling on matches',
            'loyal to their favorite fighters',
        ],
        'tone': 'boisterous, animated, competitive',
        'topic_lean': ['sports'],
    },
    {
        'key': 'grumbler',
        'label': 'a grumbler who complains about everything',
        'traits': [
            'cynical about prices and politics',
            'always finds something to moan about',
        ],
        'tone': 'sour, weary, sarcastic',
        'topic_lean': ['news', 'weather', 'complaints'],
    },
    {
        'key': 'historian',
        'label': 'a history buff who connects today to old tales',
        'traits': [
            'knowledgeable about lore and legends',
            'likes to draw lessons from the past',
        ],
        'tone': 'thoughtful, nostalgic, learned',
        'topic_lean': ['history', 'news'],
    },
    {
        'key': 'merchant',
        'label': 'a shrewd merchant always talking trade',
        'traits': [
            'keeps an eye on prices and supply',
            'always looking for a good deal',
        ],
        'tone': 'practical, persuasive, opportunistic',
        'topic_lean': ['trade', 'news'],
    },
    {
        'key': 'romantic',
        'label': 'a hopeless romantic with their head in the clouds',
        'traits': [
            'notices courtship and weddings everywhere',
            'believes in love and happy endings',
        ],
        'tone': 'warm, dreamy, sentimental',
        'topic_lean': ['gossip', 'people'],
    },
    {
        'key': 'philosopher',
        'label': 'a quiet philosopher musing on the world',
        'traits': [
            'reflects on war, fate, and the meaning of it all',
            'speaks in measured, thoughtful phrases',
        ],
        'tone': 'calm, pensive, abstract',
        'topic_lean': ['history', 'news'],
    },
    {
        'key': 'joker',
        'label': 'a joker who cannot take anything seriously',
        'traits': [
            'turns every topic into a punchline',
            'teases friends and strangers alike',
        ],
        'tone': 'playful, cheeky, irreverent',
        'topic_lean': ['sports', 'gossip'],
    },
    {
        'key': 'worrier',
        'label': 'a worrier who frets about what is coming next',
        'traits': [
            'anxious about bad omens and hard times',
            'looks for trouble before it finds them',
        ],
        'tone': 'nervous, fretful, superstitious',
        'topic_lean': ['news', 'weather', 'superstition'],
    },
]
